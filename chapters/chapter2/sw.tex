...
\begin{strategy}[Static comparison of variants]
    ...
    At the low-level of bytecode instructions, these metrics include the Jaccard distance between n-grams \cite{ngrams}, the Levenshtein distance \cite{DBLP:journals/corr/abs-2111-09934}, and global alignments \cite{CROW}. 
