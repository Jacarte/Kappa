...
\todo{Artificial can be systematic: covers more, you define a topology whle humans tend to think alike \cite{?}.}
...
\begin{strategy}[Enumerative synthesis]
    ...
    \todo{Mention that is systematic}
...
\begin{strategy}[Offensive Diversification]    
    ...
    \todo{Compare to pbfuscation. Obfuscation wanst to prevent reverse engineering while offensive wants to avoid detection.}
