...
Although this rewriting approach may appear simplistic, especially because compilers often eliminate it through \emph{Constant Folding} optimization \cite{constant_folding}, it stresses on the spill/reload component of the compiler when the \Wasm binary is JITed to machine code.
