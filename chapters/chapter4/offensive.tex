...
\begin{figure}[h]
    ...
    \caption{A remote minig pool server, a JavaScript wrapper and the \Wasm binary form the triad of a cryptojacking attack in browser clients.}
...
\begin{figure}
    ...
    \caption{Cryptojacking scenario in which the malware detection mechanism is bypassed by using an evasion technique. Taken from \cite{EVASION}}
