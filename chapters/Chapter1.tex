...
Despite being the main scripting language in modern web browsers, JavaScript has inherent limitations due to its unique language characteristics \cite{mulazzani2013fast}.
