...
\wrule{Artificial Software Diversification:} The concept of artificial software variants starts with Randell's 1975 work \cite{10.1145/390016.808467}, which put forth the notion of artificial fault-tolerant instruction blocks. 
...
\wrule{Code obfuscation:} Code obfuscation \cite{wobfuscator} can be seen as a simplification of \emph{ISA randomization}. 
...
%The application of enumerative synthesis to \Wasm has not been explored, and it is actually one of our contributions. 
...
\wrule{Automated equivalence checking:} In the absence of a test suite or a technique that inherently implements the equivalence property, the works mentioned earlier use theorem solvers (SMT solvers) \cite{SMT_solver} to prove equivalence of program variants. 
