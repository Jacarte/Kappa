...
\wrule{Static analysis and validation:} The toolkit for analysing \Wasm binaries is rich and varied. 
...
While many existing tools  self-rigorous correctness evaluations and extensive test suites, the \Wasm ecosystem is still in its infancy. 
...
\todo{Add the recent ones.}

\todo{Standalone implementations: WASI, WASM3, WASMtime, WASM3, WAVM, WAM}

\todo{Section on current tools.}
