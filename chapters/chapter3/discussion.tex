...
The layout alteration of a \Wasm program intrinsically impacts its managed memory during runtime. 
This impact bears significant relevance for CROW and MEWE as they do not directly address the \Wasm memory model. 
Nevertheless, by modifying the \Wasm program layout, CROW and MEWE effect considerable changes in the managed memory.
...
Overall, memory alterations, either to the unmanaged or managed memories, have substantial security implications, by eliminating potential cache timing side-channels \cite{Swivel}.
