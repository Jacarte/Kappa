...
Although this rewriting approach may seem simplistic, especially because compilers often eliminate it through \emph{Constant Folding} optimization \cite{2023arXiv230513241T}, it stresses on the spill/reload component of the compiler when the \Wasm binary is JITed to machine code.
