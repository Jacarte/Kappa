...
\begin{enumerate}[label=\textbf{P\arabic*}, ref=C\arabic*]
	...
	\item \label{prob3} \textbf{Side-channel attacks}:
 
	\item \label{prob4} \textbf{WebAssembly security}:
	
	\item \label{prob1} \textbf{Reactive defenses}: Existing WebAssembly research mostly reacts to existing vulnerabilities, leaving the potential for unidentified attacks. 
