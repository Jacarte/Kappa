...
Software variants refer to functionally equivalent versions of an original program, produced through Software Diversification at various stages of the software lifecycle, from dependencies (coarce-grained) to machine code levels (fine-grained).
...
\begin{strategy}[Rewriting strategy]
    ...
    The automatic creation of Software Diversification commences with rewriting rules.
...
\begin{strategy}[Enumerative synthesis]
    ...
    If the generated variant is proved, it is added to the variant's collection.
