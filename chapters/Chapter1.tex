...
\begin{enumerate}[label={\textbf{P\arabic*}:}, ref={P\arabic*}]
	...
	The rise of cryptojacking malware has sparked numerous protective measures. 
	However, these defenses have not factored in the potential use of evasion techniques by attackers. 
