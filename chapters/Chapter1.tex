...
While WebAssembly is praised for its security, especially for its design that prevents programs from accessing data beyond their own memory, it is not exempt from vulnerabilities. 
