...
This approach not only has the potential to exceed handcrafted optimizations \cite{Sasnauskas2017Souper:Superoptimizer} but also ensures that the transformations are \temph{preserved}. 
