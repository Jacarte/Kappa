...
!%3 = mul nsw %0, 3:i32!
    ...
    \hrule
    \vspace{2mm}
    \captionof{lstlisting}{Candidate code replacement combination. Orange highlighted code illustrates replacement candidate overlapping.}\label{example:crow:original:combination}
\end{minipage}
