...
\begin{tcolorbox}[title=Reflection,boxrule=1pt,arc=.2em,boxsep=1.0mm]  
    ...
    Specifically, the current literature acknowledges only metadata (\Wasm custom sections) obfuscation or the total absence of obfuscation techniques for \Wasm \cite{Minesweeper, MinerRay, SEISMIC, RAPID, MINOS}. 
