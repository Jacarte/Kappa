...
\todo{Introduce here SFI by design}
...
\todo{Introduce CFI by design here !}
...
%%ORIGINAL
\wrule{Static analysis:} SecWasm\cite{secwasm} uses information control-flow checking to identify vulnerabilities in \Wasm binaries. 
...
However, there exist approaches to harden \Wasm binaries, enhancing their secure execution, and hardening the security of the entire execution runtimes ecosystem. 
