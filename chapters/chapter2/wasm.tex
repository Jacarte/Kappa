...
\wrule{\Wasm module execution:} \Wasm is optimized and closely aligned with machine code for performance reasons, which typically results in fast JIT compilation for execution.
