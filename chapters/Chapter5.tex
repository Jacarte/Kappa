...
Once used, the diversified program is never used again. 
...
In the backend, we must guarantee that the \Wasm binary is unique per server instance and per request \cite{Sledge, Swivel, 10.1145/3572848.3577436}.
