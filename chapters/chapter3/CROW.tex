...
%\emph{Exploration}
\msubsection{Variants' space exploration}
...
CROW is developed by modifying the enumerative synthesis implementation found in Souper \cite{Sasnauskas2017Souper:Superoptimizer}, an LLVM-based superoptimizer. 
