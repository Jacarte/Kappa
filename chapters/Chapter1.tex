...
Eichin \etal \cite{36307} presented seminal work in 1989, illustrating the practical benefits of diversification. 
Specifically, the diversification limited the Morris Worm's exploitation to a handful of machines. 
...
Moreover, we note that current solutions to mitigate side-channel attacks on \Wasm binaries either target specific attacks or necessitate the modification of runtimes. 
...
\todo{TBD: Add here the case of the redundance rail systems in Sweden in early times instead the Morris Worm.}
