...
\titleformat{\chapter}[display]
  ...
  {\LARGE{\tiny Version \today\ \currenttime\\}}
  ...
  \vspace{-13.5ex}\filleft\parbox[b]{0.5\textwidth}{\begin{flushright}\MakeUppercase{#1}\\\end{flushright}}\hspace*{-0.08cm}\vspace{-0.5cm}}
  [\vspace{0.1ex}]
...
\titleformat{\subsection}
  {\large}{\MySecSquare}{1em}{\thesubsection\ #1}
  
\titleformat{name=\subsection,numberless}
  {\large}{\hspace{0.25em}\MySecSquare}{1em}{\thesubsection\ #1}
