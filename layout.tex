...
\titleformat{\chapter}[display]
  ...
  {\LARGE}
  {
    \footnotetext[0]{\tiny Compilation probe time \today\ \currenttime\\}\renewcommand{\thechapter}{\arabic{chapter}\color{gray}\vspace{2.0ex}\titlerule}
  %\colorbox{blacm}
  {\begin{flushright}{\bfseries\fontsize{65}{70}\selectfont
    \arabic{chapter} 
      } \end{flushright}}}
  {-2ex}
  {\vspace{-1cm}\filleft\parbox[b]{0.5\textwidth}{\begin{flushright}\fontsize{18}{20}\selectfont\MakeUppercase{#1}\\\end{flushright}}\vspace{-0.5cm}}
  [\vspace{0.1ex}]
